...
namespace Base.Common.Infrastructure;
...
public static class QueueFactory
{
    ...
    public static EventingBasicConsumer CreateBasicConsumer()
    {
        ...
        { 
            HostName = BaseConstants.RabbitMQHost, 
            Port = BaseConstants.RabbitMQPort
        };
    ...
    public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer, 
                                                       string exchangeName, 
                                                       string exchangeType = BaseConstants.DefaultExchangeType)
    {
